                ...
                @foreach (Gloudemans\Shoppingcart\Facades\Cart::instance('shopping')->content() as $item)
                    <tr class="cart__row border-bottom line1 cart-flex border-top">
                        <td class="cart__image-wrapper cart-flex-item">
                            <a href="#"><img class="cart__image" src="{{$item->model->photo}}" alt="Elastic Waist Dress - Navy / Small"></a>
                        </td>
                        ...
                        <td class="cart__update-wrapper cart-flex-item text-right">
                            <div class="cart__qty text-center">
                                <div class="qtyField">
                                    ...
                                    <input class="cart__qty-input qty qty-text" data-id="{{$item->rowId}}" id="qty-input-{{$item->rowId}}" type="number" name="" id="qty" value="{{$item->qty}}" pattern="[0-9]*">
                        ...
                        <td class="text-center small--hide "><a href="" class="btn btn--secondary cart__remove cart_delete" data-id="{{$item->rowId}}" title="Remove tem"><i class="icon icon anm anm-times-l"></i></a></td>
                    </tr>
                @endforeach
            </tbody>
            <tfoot>
    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-4 col-lg-4 mb-4">
            ...
            <form action="{{route('coupon.add')}}" id="coupon-form" method="post">
                ...
                <div class="actionRow">
                    <div><button type="submit" class="btn btn-secondary btn--small coupon-btn">Apply Coupon</button></div>
                </div>
            </form>
        </div>
        <div class="col-12 col-sm-12 col-md-4 col-lg-4 mb-4">
        ...
        <div class="col-12 col-sm-12 col-md-4 col-lg-4 cart__footer">
            <div class="solid-border">	
              <div class="row border-bottom pb-2">
                ...
                <span class="col-12 col-sm-6 text-right"><span class="money">${{Gloudemans\Shoppingcart\Facades\Cart::subtotal()}}</span></span>
              </div>
              <div class="row border-bottom pb-2 pt-2">
                <span class="col-12 col-sm-6 cart__subtotal-title">Save Amount</span>
              ...
              <a href="{{route('checkout1')}}" class="btn btn--small-wide checkout" style="color: white; height:40px; width:300px; margin-left:20px;">Proceed To Checkout</a>
