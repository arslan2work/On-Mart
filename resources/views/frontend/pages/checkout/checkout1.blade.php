        ...
        <div id="page-content" style="margin-top: 70px;">
            ...
            <div class="container">
                ...
                <div class="row billing-fields">
                    {{-- billing details --}}
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 sm-margin-30px-bottom mb-3">
                                ...
                                <fieldset>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                            ...
                                            <input name="first_name" value="{{$name[0]}}" id="first_name" type="text">
                                        </div>
                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                            <label for="input-lastname">Last Name <span class="required-f">*</span></label>
                                            <input name="last_name" value="{{$name[1]}}" id="last_name" type="text">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                            <label for="input-email">E-Mail <span class="required-f">*</span></label>
                                            <input name="email" value="{{$user->email}}" id="email" type="email" readonly>
                                        </div>
                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                            <label for="input-telephone">Telephone <span class="required-f">*</span></label>
                                            <input name="phone" value="{{$user->phone}}" id="phone" type="tel">
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset>
                                    <div class="row">
                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                            ...
                                            <input name="country" value="{{$user->country}}" id="country" type="text" placeholder="eg. Pakistan">
                                        </div>
                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                            ...
                                            <input name="postcode" value="{{$user->postcode}}" id="postcode" type="text">
                                        </div>
                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                            <label for="input-city">City <span class="required-f">*</span></label>
                                            <input name="city" value="{{$user->city}}" id="city" type="text">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                            <label for="input-zone">Region / State <span class="required-f">*</span></label>
                                            <input name="state" value="{{$user->state}}" id="state" type="text" placeholder="eg. Punjab">
                                        </div>
                                    </div>
                                </fieldset>
                            ...
                            <div class="create-ac-content bg-light-gray padding-20px-all">
                                    <fieldset>
                                        <div class="row">
                                            <div class="form-group form-check col-md-12 col-lg-12 col-xl-12">
                                                ...
                                                <label class="form-check-label padding-15px-left" for="customCheck1"><strong>Ship to billing address?</strong></label>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                                <label for="input-firstname">First Name <span class="required-f">*</span></label>
                                                <input name="sfirst_name" value="{{$name[0]}}" id="sfirst_name" type="text">
                                            </div>
                                            <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                                <label for="input-lastname">Last Name <span class="required-f">*</span></label>
                                                <input name="slast_name" value="{{$name[1]}}" id="slast_name" type="text">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                                <label for="input-email">E-Mail <span class="required-f">*</span></label>
                                                <input name="semail" value="{{$user->email}}" id="semail" placeholder="eg. example@example.com" type="email" readonly>
                                            </div>
                                            <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                                <label for="input-telephone">Telephone <span class="required-f">*</span></label>
                                                <input name="sphone" value="{{$user->phone}}" id="sphone" placeholder="eg . +123456789" type="tel">
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                                <label for="input-country">Country <span class="required-f">*</span></label>
                                                <input name="scountry" value="{{$user->scountry}}" id="scountry" type="text" placeholder="eg. Pakistan">
                                            </div>
                                            <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                                <label for="input-address-1">Address <span class="required-f">*</span></label>
                                                <input name="saddress" value="{{$user->saddress}}" id="saddress" type="text">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                                <label for="input-postcode">Post Code <span class="required-f">*</span></label>
                                                <input name="spostcode" value="{{$user->spostcode}}" id="spostcode" type="text">
                                            </div>
                                            <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                                <label for="input-city">City <span class="required-f">*</span></label>
                                                <input name="scity" value="{{$user->scity}}" id="scity" type="text">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                                <label for="input-zone">Region / State <span class="required-f">*</span></label>
                                                <input name="sstate" value="{{$user->sstate}}" id="sstate" type="text" placeholder="eg. Punjab">
                                            </div>
                                        </div>
                                    </fieldset>
                            </div>
                                    ...
                                    <div class="table-responsive-sm order-table"> 
                                        <table class="bg-white table table-bordered table-hover text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-left">{{$item->model->title}}</td>
                                                    <td>${{$item->price}}</td>
                                            ...
                                            <tfoot class="font-weight-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>${{Illuminate\Support\Facades\Session::get('coupon')['value']}}</td>
                                                </tr>
                                                @endif
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                            <div class="your-order-payment">
                                <div class="your-order">
                                    <h2 class="order-title mb-4">Shipping method</h2>
                                            ...
                                            <tbody>
                                                @if (count($shippings) > 0)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="radio" id="radio{{$key}}" name="delivery_charge" value="{{$item->delivery_charge}}">
                                                            <label for="radio{{$key}}"></label>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                @else
                                                <tr><td colspan="4">No Shipping method found</td></tr>
                                                @endif
                                            ...
                                            <div id="accordion" class="payment-section">
                                                ...
                                                <div class="card mb-2">
                                                    ...
                                                    <div id="collapseOne" class="collapse" data-parent="#accordion">
                                                        <div class="card-body">
                                                            <p class="no-margin font-15">Make your payment directly whe the product reached at your doorstep. CLick the button if you require cash on delivery opportunity.</p>
                                                            <input type="text" value="paid" name="payment_status" hidden> 
                                                            <input type="checkbox" value="cod" name="payment_method" id="payment_method">
                                                            <label for="payment_method">Need cash on delivery</label>
                                                        ...
                                                        <div class="card-body">
                                                            <fieldset>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                                                        <img class="padding-25px-top xs-padding-5px-top" src="{{asset('frontend/assets/images/payment-img.jpg')}}" alt="card" title="card" />
                                                                    </div>
                                                                </div>
                                                            </fieldset>
