            ...
            <div class="card-body">
              <div class="row">
                <div class="col-lg-3 col-md-6">
                  <div class="d-flex">
                    <div class="wrapper">
                      <h3 class="mb-0 font-weight-semibold">{{\App\Models\Category::where('status', 'active')->count()}}</h3>
                ...
                <div class="col-lg-3 col-md-6 mt-md-0 mt-4">
                  <div class="d-flex">
                    <div class="wrapper">
                      <h3 class="mb-0 font-weight-semibold">{{\App\Models\Product::where('status', 'active')->count()}}</h3>
                ...
                <div class="col-lg-3 col-md-6 mt-md-0 mt-4">
                  <div class="d-flex">
                    <div class="wrapper">
                      <h3 class="mb-0 font-weight-semibold">{{\App\Models\User::where('status', 'active')->count()}}</h3>
                      <h5 class="mb-0 font-weight-medium text-primary">New Customers</h5>
                ...
                <div class="col-lg-3 col-md-6 mt-md-0 mt-4">
                  <div class="d-flex">
                    <div class="wrapper">
                      ...
                      <h5 class="mb-0 font-weight-medium text-primary">Net Profit</h5>
                      <p class="mb-0 text-muted">+138.97(+0.54%)</p>
                    </div>
                    <div class="wrapper my-auto ml-auto ml-lg-4">
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="{{route('coupon.edit', $order->id)}}"  title="view" data-placement="bottom" style="width: 40px;" class="float-left btn btn-sm btn-outline-warning"> <i class="fa fa-eye" aria-hidden="true"></i></a>
                              <form class="float-left " action="{{route('coupon.destroy', $order->id)}}" method="POST">
                                @csrf
                                @method('delete')
