...
<div class="col-md-8 offset-2 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form action="{{route('coupon.update', $coupon->id)}}" class="forms-sample" method="POST">
            @csrf
            @method('patch')
          <div class="form-group">
            <label for="exampleInputName1">Coupon Code <span class="text-danger">*</span></label>
            <input type="text" name="code" class="form-control" id="exampleInputName1" placeholder="Code" value="{{$coupon->code}}">
          </div>
          <div class="form-group">
            <label for="exampleInputName1">Coupon Value <span class="text-danger">*</span></label>
            <input type="text" name="value" class="form-control" id="exampleInputName1" placeholder="Value" value="{{$coupon->value}}">
          </div>
