...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title"><strong>Banners</strong></h4>
          ...
          <tbody>
              @foreach ($banners as $item)
                  <tr>
                    ...
                    <td>
                      <a href="{{route('banner.edit', $item->id)}}"  title="edit" data-placement="bottom" style="width: 40px;" class="float-left btn btn-sm btn-outline-warning"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
 
                      <form class="floar-left " action="{{route('banner.destroy', $item->id)}}" method="POST">
                        @csrf
                        @method('delete')
