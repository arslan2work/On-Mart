              ...
              @foreach ($products as $item)
                ...
                @endphp
                  <tr>
                    ...
                    <td>
                      <a href="{{route('product.show', $item->id)}}"   title="add-attribute" data-placement="bottom" style="width: 40px;" class="mr-1 mb-1 float-left btn btn-sm btn-outline-primary"> <i class="fa fa-plus-circle" aria-hidden="true"></i></a>
                      ...
                      <a href="{{route('product.edit', $item->id)}}"  title="edit" data-placement="bottom" style="width: 40px;" class="float-left btn btn-sm btn-outline-warning"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
