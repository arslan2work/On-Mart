          ...
          <tbody>
              @foreach ($users as $item)
                  <tr>
                    ...
                    <td><img src="{{$item->photo}}" alt="user image" style="max-height: 90px; max-width:120px "></td>
                    ...
                    <td>
                      <a href="javascript:void(0);" data-toggle="modal" data-target="#userID{{$item->id}}"  title="view" data-placement="bottom" style="width: 40px;" class="float-left btn btn-sm btn-outline-primary"> <i class="fa fa-eye" aria-hidden="true"></i></a>

                      <a href="{{route('user.edit', $item->id)}}"  title="edit" data-placement="bottom" style="width: 40px;" class="float-left ml-1 btn btn-sm btn-outline-warning"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-content">
                          <div class="text-center">
                            <img src="{{$user->photo}}" style="border-radius: 50%; margin:2% 0; max-height:90px; max-width:90px;"><br/>
                          </div>
