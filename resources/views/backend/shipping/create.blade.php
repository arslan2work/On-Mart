...
<div class="col-md-8 offset-2 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form action="{{route('shipping.store')}}" class="forms-sample" method="POST">
            @csrf
          ...
          <div class="form-group">
            ...
            <input type="datetime-local" name="delivery_time" class="form-control" id="exampleInputName1" placeholder="Delivery Time" value="{{old('delivery_time')}}">
          </div>
          <div class="form-group">
            <label for="exampleInputName1">Delivery Charge <span class="text-danger">*</span></label>
            <input type="number" name="delivery_charge" class="form-control" id="exampleInputName1" placeholder="Delivery Charge" value="{{old('delivery_charge')}}">
          </div>
          <div class="form-group">
